...
//Code Here
/*switch(letterGrade){
  case A:"The student is doing excellently"
    console.log()
    break
  case B:"The student is doing well"
    console.log()
    break
  case C:"The student is doing alright" 
    console.log()
    break
  case D:"The student is not doing very well" 
    console.log()
    break
  case F:"The student it failing"
    console.log()
    break 
}
